...
query_templates = [
    ...
    (lambda table, column, min_max: (f"SELECT * FROM {table} WHERE {column} BETWEEN {random_number(*min_max)} AND {random_number(*min_max)};", f"Selects rows where '{column}' falls between two random values."), ['numeric']),
